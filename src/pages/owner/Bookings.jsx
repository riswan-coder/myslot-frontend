...
import { getMyBookings, completeBooking, cancelBooking } from '../../api/owner'
    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-8 space-y-6">
        ...
        <div className="space-y-3">
          {filtered.map((b) => (
            <div key={b.id} className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 flex justify-between items-center">
              <div>
              ...
              {b.status === 'upcoming' && (
                <div className="flex gap-2">
                  <button
                    ...
                    className="text-xs border border-zinc-700 hover:bg-zinc-800 px-3 py-1.5 rounded-lg"
                  >
                    Mark Completed
                  </button>
                  <button
