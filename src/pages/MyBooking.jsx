            ...
            {booking.status === 'completed' && !reviewSubmitted && (
              <form onSubmit={handleSubmitReview} className="border-t border-zinc-800 pt-4 mt-4 space-y-3">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-zinc-950 border border-zinc-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-orange-500"
                />
                <button
                  type="submit"
                  disabled={submittingReview}
                  className="w-full bg-orange-500 hover:bg-orange-600 disabled:opacity-50 py-2.5 rounded-lg text-sm font-medium"
                >
